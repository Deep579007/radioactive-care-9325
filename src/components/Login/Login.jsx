  ...
  return (
    <div className="LoginCon">
      ...
      <div className="inputBox">
        ...
        <Box className="smartBox" sx={{display:"flex", 
                        flexDirection:"row",
                        gap:"5%", 
                        fontSize:"25px",
                        textAlign:"center",
        ...
        <form onSubmit={formSubmit}>
          <div>
            ...
            <Input
              ...
              maxLength={10}
            />
            { data<1000000000 && data>0 ? <div style={{color:"red",textAlign:"left",display:"flex",alignItems:"center"}}><img src="https://login.kfc.co.in/auth/resources/1vkce/login/kfcIndiaLoginUIDev_2021_10_27_16_49/images/Error.svg" alt=""/><span style={{marginLeft:"10px"}}>Please enter a valid 10-digit mobile number</span></div> : ""}
             <br />
          </div>
          <Button type="submit"
            sx={{
